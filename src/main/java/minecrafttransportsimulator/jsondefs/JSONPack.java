...
public class JSONPack{
	...
	@JSONDescription("A number that represents the file structure of this pack.  0 is default, 1 is layered, and 2 is modular.  This is to allow flexibility in how you arrange your pack components and to make it easier to see where things are and where components are missing.  Each structure is explained in detail in the following sections.  However, there are a few things you should be aware of:<ul>"
			+ "<li>All assets MUST be located in 'assets/[yourpackid]'  This prefix will be omitted in the follwing section for clarity, but please remember this.</li>"
			+ "<li>Whenever you see a [===], it means that you can put the listed component into a sub-folder for easier organization.</li>"
			+ "<li>Whenever you see a [+++] it means that the activator/blocker folder should be used at this point, if you have one set and wish to use it for the assets.  If not, you can simply omit the folder.</li>"
			+ "<li>Whenever you see a [###] it means that the component-specific folder name needs to be used here.  This is based on the name of the component.  For example, vehicles go in a 'vehicles/' folder.</li>"
			+ "<li>The main 1024x1024 instrument texture is located in 'assets/[yourpackid]/textures'. It cannot go anywhere else, even if you have sub-folders for textures.</li>"
			+ "<li>Sounds are located in the “assets/[yourpackid]/sounds” folder.</li>"
			+ "</ul>"
			+ "The default structure is the classic pack format.  Pack components are grouped into folders based on their type, and some sub-folders exist that allow for some segmentation of components.  Item textures and optional JSON models are hard-coded to the “textures/items” and “models/item” folders respectively.  No sub-folders are permitted anywhere except the jsondefs folder.  Therefore, the folder structure is as follows:<ul>"
			+ "<li>Pack JSON: “assets/[yourpackid]/[+++]/jsondefs/[###]/[===]/component.json”</li>"
			+ "<li>OBJ Models: “assets/[yourpackid]/objmodels/[###]/component .obj”</li>"
			+ "<li>OBJ Textures: “assets/[yourpackid]/textures/[###]/component .png”</li>"
			+ "<li>Item Textures: “assets/[yourpackid]/textures/items/[###]/component .png”</li>"
			+ "<li>Item JSON: “assets/[yourpackid]/models/item/[###]/component .json”</li>"
			+ "</ul>"
			...
			+ "<li>Pack JSON: “assets/[yourpackid]/[+++]/[###]/[===]/component .json”</li>"
			+ "<li>OBJ Models: “assets/[yourpackid]/[+++]/[###]/[===]/component .obj”</li>"
			+ "<li>OBJ Textures: “assets/[yourpackid]/[+++]/[###]/[===]/component .png”</li>"
			+ "<li>Item Textures: “assets/[yourpackid]/[+++]/[###]/[===]/component_item.png”</li>"
			+ "<li>Item JSON: “assets/[yourpackid]/[+++]/[###]/[===]/component_item.json”</li>"
			+ "</ul>")

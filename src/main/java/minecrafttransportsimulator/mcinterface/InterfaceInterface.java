...
public class InterfaceInterface{
	...
	public static BuilderEntityExisting toExternal(AEntityB_Existing entity){
		for(Entity mcEntity : entity.world.world.loadedEntityList){
	...
	public static BuilderTileEntity<?> toExternal(ATileEntityBase<?> tile){
		return (BuilderTileEntity<?>) tile.world.world.getTileEntity(new BlockPos(tile.position.x, tile.position.y, tile.position.z));
	}
